...
# Streamlit UI layout
st.title("AI powered Speech recognition and translation")
st.write("**This part is only the Deployment-friendly part of our graduation project in DEPI, we did a whole Real-time pipeline that is not deployed yet. Thanks!**")
